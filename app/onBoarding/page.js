    ...
    <div className="relative w-screen h-screen bg-black flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[420px] mx-4">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-white text-2xl font-bold tracking-tight">Set up your profile</h1>
        ...
        <p className="text-center text-white/20 text-xs mt-4">You can change all of this later in your profile</p>
      </div>
    </div>
  );
}